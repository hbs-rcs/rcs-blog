...
# Pin the Stata version for the same reason as the other Stata posts: the
# newest install here (StataNow19) has broken batch-mode graphics. Set STATA_EXE
# to override; if the path below is absent, auto-detection takes over.
