...
```{r stata-chunk, engine='stata', engine.path='C:/Program Files/Stata17/StataMP-64.exe', cache=TRUE}
clear
sysuse auto
xtset rep78
...
```{r stata-chunk2, engine='stata', engine.path='C:/Program Files/Stata17/StataMP-64.exe', cache=TRUE}
clear
sysuse auto
xtset rep78
