...
```{r stata-chunk, engine='stata', engine.path='C:/Program Files/Stata17/StataMP-64.exe'}
webuse union3
...
```{r stata-chunk2, engine='stata', engine.path='C:/Program Files/Stata17/StataMP-64.exe'}
sysuse auto
sum mpg
...
```{r, echo=FALSE, results="hide", engine='stata', engine.path='C:/Program Files/Stata17/StataMP-64.exe'}
