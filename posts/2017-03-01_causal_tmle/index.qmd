...
description: "In an observational study, we need to assume we have the functional form to get causal effect estimated correctly, in addtion to the assumption of treatment being exogenous."
---
...
```
    ...
    ##               p-value:  <2e-16
    ##     95% Conf Interval: (1.9202, 2.1323)
